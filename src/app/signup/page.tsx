    ...
    return (
        <main className="min-h-screen bg-[#1a1a2e] flex flex-col items-center justify-center p-6 text-white relative">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-pink-600/20 rounded-full blur-[100px]" />
            ...
            <div className="relative z-10 w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-2xl shadow-2xl">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-purple-400 mb-2">
                        Create Account
                    </h1>
                    <p className="text-gray-400">Join MangaCloud to track your reading.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 mb-6">
                    ...
                    <button
                        ...
                        className="w-full bg-gradient-to-r from-pink-600 to-purple-600 text-white font-bold py-3 px-4 rounded-xl hover:opacity-90 transition-opacity disabled:opacity-50"
                    >
                ...
                <div className="relative py-4 mb-4">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-[#1a1a2e] px-2 text-gray-500 font-medium">Or sign up with</span>
                    </div>
                </div>
